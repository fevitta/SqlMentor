...
def _is_scalar_index_subquery(
    b: PlanBlock, blocks: list[PlanBlock], i: int
) -> tuple[bool, list[PlanBlock]]:
    """
...
_OPTIMIZER_DEFAULTS: dict[str, tuple[str, str]] = {
    ...
    "optimizer_features_enable": ("", "Versão de features do otimizador"),
    "cursor_sharing": ("EXACT", "Compartilhamento de cursores"),
    "db_file_multiblock_read_count": ("", "Blocos por multiblock read"),
